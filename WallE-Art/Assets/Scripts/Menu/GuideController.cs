...
public class GuideUIController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        guidePages.Add("\"SUPER WALLE BROs\" se divide en dos módulos principales: \nEditor de Pixel Art: Permite a los usuarios instrucciones simples que le permiten \"pintar\" en un lienzo. \nGenerador de Niveles de Plataformas: Una característica extendida que transforma imágenes de textura 2D en niveles jugables de plataformas, donde Wall-E puede moverse y alcanzar objetivos. ");
        guidePages.Add("IMPORTANTE \n Para crear un nivel es necesario crear una textura 2D en el editor y que contenga solamente un cuadrado de 2x2 pixeles amarillos Color(\"yellow\") para definir la posicion donde surge walle y solo un pixel Color(\"pink\") para la posicion del objetivo de victoria del nivel(La bota de walle)");
